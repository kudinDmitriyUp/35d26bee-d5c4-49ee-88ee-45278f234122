...
export const metadata: Metadata = {
  title: "CineVision | Professional Video Production & Filmmaking",
  description: "Award-winning video production company specializing in commercials, documentaries, and corporate films. Bringing your vision to life with cinematic excellence.",
  keywords: "video production, filmmaking, commercial production, documentary, corporate videos, professional video",
  metadataBase: new URL("https://cinevision.com"),
  alternates: {
    canonical: "https://cinevision.com"
  },
  robots: {
    index: true,
    follow: true
  ...
  openGraph: {
    title: "CineVision | Professional Video Production",
    description: "Award-winning video production and filmmaking services",
    type: "website",
    siteName: "CineVision",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1764789560567-qksffi2u.jpg",
        alt: "CineVision video production"
      }
    ]
  },
  twitter: {
    ...
    title: "CineVision | Professional Video Production",
    description: "Award-winning video production and filmmaking services",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1764789560567-qksffi2u.jpg"]
  }
};
